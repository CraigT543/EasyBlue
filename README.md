...
This is my latest build of Easy!Appointments by Alex Tselegidis found at http://easyappointments.org/ and at https://github.com/alextselegidis/easyappointments.  Alex has been very generous to share this. My modifications are a little hacky and ammeture but they work to do some things that are necessary for clinical practice to flow: A waiting list, reminders x number of days before appointments by text and email, and automatic sync of the database with Google Calendar that includes recurring appointment information.  Those were my needs.
