...
(function(exports) {
    ...
    exports.getAvailableHours = function(selDate) {
        ...
        $.post(postUrl, postData, function(response) {
            ...
            if (response.length > 0) {
                ...
                //ORIGINAL  $('#available-hours').html('<div style="width:50px; float:left;"></div>');
				$('#available-hours').html('<div style="width:80px; margin:0 auto;"></div>');
                ...
                $.each(response, function(index, availableHour) {
                    if ((currColumn * 10) < (index + 1)) {
                        ...
                        //ORIGINAL $('#available-hours').append('<div style="width:50px; float:left;"></div>');
    ...
    exports.getUnavailableDates = function(providerId, serviceId, selectedDateString) {
        ...
        var data = {
			max_date: FrontendBook.max_date, /*MaxDate mod Craig Tucker*/		
