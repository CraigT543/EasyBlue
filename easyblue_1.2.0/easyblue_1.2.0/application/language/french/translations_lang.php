...
$lang['waiting_list_msg_top'] = 'En vous inscrivant ici, vous recevrez un courriel quotidien ou un courriel et des avis de texte pendant 30 jours concernant toute disponibilité que j\'ai au cours des 60 prochains jours. Vous pouvez renouveler votre place sur la liste d\'attente aussi souvent que vous le souhaitez. Pour être supprimé de la liste, cliquez sur le lien de votre message électronique / texte pour le supprimer.';
...
$lang['show_price'] = 'Afficher le prix du service défini à 0';
$lang['show_price_hint'] = 'Si vous avez des services que vous ne facturez pas ou qu\'ils sont gratuits, vous pouvez décider de ne pas l\'afficher la devise dans l\'écran initial';
