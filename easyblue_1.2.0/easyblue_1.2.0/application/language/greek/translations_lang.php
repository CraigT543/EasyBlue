...
$lang['waiting_list_msg_top'] = 'By registering here you will be sent daily email or email and text notices for 30 days regarding any availability I have over the next 60 days. You can renew your place on the waiting list as often as you like.  To be removed from the list click the link on your email/text message for removal.';
...
$lang['show_price'] = 'Show Price of service when set to 0';
$lang['show_price_hint'] = 'If you have services that you do not charge for or that are free, you may not want to display the currency in the initial screen';
